...
export class GrantCommandService {
  ...
  async revokeGrant(actorId: string | null, grantId: string, dto: RevokeGrantDto) {
    ...
    const result = await this.grantsRepository.revokeGrant({
        id: grant.id,
...
```ts
import { Injectable } from '@nestjs/common';
import { GrantEffect, GrantStatus, GrantTargetType, PrismaClient } from '@prisma/client';
